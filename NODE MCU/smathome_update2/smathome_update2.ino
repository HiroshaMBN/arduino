...
String room2On,room2Off,room3On,room3Off,room4On,room4Off,livingAreaOn,livingAreaOff,fan6On,fan6Off;
//room1
void myroom1On()
{
  digitalWrite(5, HIGH);
...
void mylivingAreaOn()
{
  ...
  server.send(200, "text/html", livingAreaOn);
}
void mylivingAreaOff()
{
  digitalWrite(14,LOW);
  server.send(200, "text/html", livingAreaOff);
}
...
//  server.on("/room3Off",myroom3Off);
  ...
  server.on("/livingAreaOn", mylivingAreaOn);
  server.on("/livingAreaOff", mylivingAreaOff);
