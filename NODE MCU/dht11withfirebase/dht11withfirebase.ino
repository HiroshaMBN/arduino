...
#define FIREBASE_HOST "my-first-project2-bc155-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "HDBv5bGOyVtCCm6SCItALHfOAlO0jCn4EFWN6urQ"
#define WIFI_SSID "linkA"
